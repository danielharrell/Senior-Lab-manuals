...
\draw[overlay,decorate,
    decoration = {brace,raise=2pt,amplitude=4pt,aspect=0.45}]([shift={(0pt,2pt)}]pic cs:3) -- ([shift={(0pt,2pt)}]pic cs:4);
\draw[overlay,decorate,
    decoration = {brace,raise=2pt,amplitude=4pt,aspect=0.45}]([shift={(0pt,3pt)}]pic cs:6) -- ([shift={(0pt,2pt)}]pic cs:5);
\draw[overlay,decorate,
