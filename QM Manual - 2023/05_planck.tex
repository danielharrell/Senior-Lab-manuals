...
%= \frac{4b}{a}[\frac{x}{2}({a^{2} - x^{2})}^{\frac{1}{2}} + \frac{a^{2}}{2}\sin^{- 1}({\frac{x}{a})}]_{0}^{a} = \pi ab,\] 
...
\[{A = 4\int_{0}^{a}b(1 - \frac{x^{2}}{a^{2}}})^{\frac{1}{2}}dx = \frac{4b}{a}\int_{0}^{a}{({a^{2} - \ x^{2})}^{\frac{1}{2}}}dx = \frac{4b}{a}[\frac{x}{2}({a^{2} - x^{2})}^{\frac{1}{2}} + \frac{a^{2}}{2}\sin^{- 1}({\frac{x}{a})}]_{0}^{a} = \pi ab,\] where the indefinite integral is found from a table of integrals.}
%
\begin{equation}
