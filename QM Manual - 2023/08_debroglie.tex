...
charge, $e$, possesses a refractive index\footnote{{[}Huygens had
  ...
  (\emph{Treatise on Light}, Junior Lab manual), or,
...
``The New Theory about Light and Colors,'' in the Junior Lab manual.} 
...
Violet.''\footnote{Newton, ``New Theory,'' Junior Lab manual; italics added.} The prism is said to
...
equation \eqref{eq:bohr_8} in Chapter \ref{ch:bohr} above followed from this ``condition of
...
other hand the electron's speed was given by\footnote{See Bohr's
  equation \eqref{eq:bohr_7} and the related footnote in Chapter \ref{ch:bohr} above.}
%
\begin{equation*}
mw^2 = \frac{e^2}{a} ,
%
...
u = \frac{h\nu}{\sqrt{2m(h\nu -V)}}.\footnote{$V$ here is potential energy. If $E$ is substituted
  ...
  \end{equation*}
  is identical to Schrödinger's Equation \ref{SchDeB}, page \pageref{SchDeB}. There he
