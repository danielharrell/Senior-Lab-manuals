...
includes those added parameters, includes \emph{also} the "vital assumption" that the 
function $B$, specifying the result for the measurement of particle 2, ``does not depend on the setting $\pmb{a}$ of the magnet for particle 1, nor $A$ on $\pmb{b}$,'' but the final result (15) contradicts those predictions expressed in (3).
