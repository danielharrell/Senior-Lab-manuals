\chapter{The Photoelectric Effect}
...
\footnotetext{There are really two yellow lines in the mercury
...
\footnotetext{(One Angstrom (Å) equals $10^{-8}$ cm.)}
...
\indent
1. Swing the photocell to the side having the brighter diffraction
pattern until the green line, say, falls on the white mask surrounding
the photocell aperture.

2. Roll the cylindrical light shield out of the way to reveal a second
